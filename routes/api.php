...
Route::middleware(['jwt.auth'])->group(function () {
    ...
    Route::prefix('onedrive')->group(function () {
        ...
        Route::post('/move-file', [OneDriveController::class, 'moveFile'])->middleware('permission:files.move');
        ...
        Route::post('/bulk-delete', [OneDriveController::class, 'bulkDelete'])->middleware('permission:files.delete');
